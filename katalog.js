...
/* Казахские строки страницы лежат в assets/lang/katalog-kk.js и грузятся
   только по выбору KZ - script.js подхватит файл по этому имени. */
window.SITE_KK_EXTRA = "katalog-kk";
...
function t(k){
  if (document.documentElement.lang === "kk") {
    var kk = window.SITE_KK_KATALOG && window.SITE_KK_KATALOG.t;
    if (kk && kk[k] !== undefined) return kk[k];
  }
  return T.ru[k];
}
