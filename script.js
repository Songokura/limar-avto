...
"c5.h":"Қозғалтқыштар",
"c5.p":"ВАЗ 1.6 / 1.8, Renault K4M / K7M / H4M, Chevrolet жиналған қозғалтқыштары - және күрделі жөндеуге қажеттінің бәрі: поршеньдер, сақиналар, ГБЦ, ГРМ жинақтары, помпалар.",
"c.cta":"Бағаны білу",
...
"alt.dvig":"Жиналған қозғалтқыш пен цилиндрлер блогы: қозғалтқыштар және күрделі жөндеу бөлшектері",
...
var TICK = {
 ru:["Запчасти для ТО","Кузов и оптика","Ходовая и подвеска","Трансмиссия и сцепление",
     "Двигатели","В наличии и на заказ","Оригинал и аналог"],
 kk:["ТО-ға арналған бөлшектер","Шанақ пен оптика","Жүріс бөлігі мен аспа","Трансмиссия және ілінісу",
     "Қозғалтқыштар","Қоймада және тапсырыспен","Түпнұсқа және аналог"]
};
